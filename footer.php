	...
	<footer id="footer">
		...
		<?php if ( has_nav_menu('footer') ): ?>
			<div id="wrap-nav-footer" class="wrap-nav">
				<div class="container">
					<?php \Writeup\Nav::nav_menu(array('theme_location'=>'footer','menu_id' => 'nav-footer','fallback_cb'=> false)); ?>
				</div>
			</div>
		<?php endif; ?>
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'writeup' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'writeup' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
						
						<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
						<div id="credit">
							<p><?php esc_html_e('Powered by','writeup'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','writeup'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
