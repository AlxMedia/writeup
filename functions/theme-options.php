...
Kirki::add_field( 'writeup_theme', array(
	'type'			=> 'switch',
	'settings'		=> 'responsive',
	'label'			=> esc_html__( 'Responsive Layout', 'writeup' ),
	'description'	=> esc_html__( 'Mobile and tablet optimizations (responsive.css)', 'writeup' ),
	'section'		=> 'general',
	'default'		=> 'on',
) );
...
Kirki::add_field( 'writeup_theme', array(
	...
	'section'		=> 'social',
	'tooltip'		=> esc_html__( 'Font Awesome names:', 'writeup' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'writeup' ) . ' </strong></a>',
	'row_label'		=> array(
		'type'	=> 'text',
	...
	'fields'		=> array(
		...
		'social-icon'	=> array(
			...
			'description'	=> esc_html__( 'Font Awesome icons. Ex: fa-facebook ', 'writeup' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'writeup' ) . ' </strong></a>',
			'default'		=> 'fa-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
